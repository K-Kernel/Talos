...
No PyTorch, no BLAS — every operatio
Runs Llama-2 architecture models. Currently: Stories15M (15M params, TinyStories)
...
|config| tok/sec| ms/token |GFLOP/s|
|---|---|---|---|
|stories15M, single-threaded, -O3, Apple M-series | 34.3| 29.2 | 1.40|
|natural-layout matvec| 154.6 | 6.47 | 4.70|
|+OpenMP, 4 threads | 467.522| 2.14 | 14.2|
...
OpenMP vectorisation gave a 3.02 x speedup
